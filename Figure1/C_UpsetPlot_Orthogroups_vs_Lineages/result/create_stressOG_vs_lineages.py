...
fout = open("Orthogroups_OG3_3_presence_absence.tsv",'w+')
with open("Orthogroups_3_3_withheader_therealone.tsv",'r') as inf:
...
with open("Orthogroups_3_3_withheader_therealone.tsv",'r') as inf:
	...
	for lines in linesafter1:
		...
		fout.write("\n")
fout.close()
df_of = pd.read_csv("Orthogroups_OG3_3_presence_absence.tsv",sep="\t",header=0)
...
result.to_csv("Orthogroup_OG3_3_lineages_presence_absence.csv")
