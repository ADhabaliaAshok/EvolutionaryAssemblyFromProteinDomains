...
IN=/usr/users/ashok/OrthologsProject/SpeciesDB/OF_run_remove_them_completely_from_this_dir/Micromonas_pusilla_CCMP1545_v3.0.protein.primaryTranscriptOnly_replaced_ast.fa
...
busco -m $MODE -i $IN -o $OUT -f -l chlorophyta_odb10 -o Micromonas_pusilla_BUSCO_out
