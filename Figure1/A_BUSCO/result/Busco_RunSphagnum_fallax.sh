...
IN=/usr/users/ashok/OrthologsProject/SpeciesDB/OF_run_remove_them_completely_from_this_dir/Sphagnum_fallax_v1.1_proteome_replaced_ast.fa
...
busco -m $MODE -i $IN -o $OUT -f -l chlorophyta_odb10 -o Sphagnum_fallax_BUSCO_out
