...
IN=/usr/users/ashok/OrthologsProject/SpeciesDB/OF_run_remove_them_completely_from_this_dir/Arabidopsis_lyrata_v2.1.protein.primaryTranscriptOnly_replaced_ast.fa
...
busco -m $MODE -i $IN -o $OUT -f -l chlorophyta_odb10 -o Arabidopsis_lyrata_BUSCO_out
