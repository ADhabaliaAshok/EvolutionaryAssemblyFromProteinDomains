...
IN=/usr/users/ashok/OrthologsProject/SpeciesDB/OF_run_remove_them_completely_from_this_dir/Ostreococcus_lucimarinus_v2.0.protein.primaryTranscriptOnly_replaced_ast.fa
...
busco -m $MODE -i $IN -o $OUT -f -l chlorophyta_odb10 -o Ostreococcus_lucimarinus_BUSCO_out
