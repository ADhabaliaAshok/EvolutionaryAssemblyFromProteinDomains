...
IN=/usr/users/ashok/OrthologsProject/SpeciesDB/OF_run_remove_them_completely_from_this_dir/Azolla_filiculoidesFeb12_proteome_replaced_ast_Jan.fa
...
busco -m $MODE -i $IN -o $OUT -f -l chlorophyta_odb10 -o Azolla_filiculoidesFeb12_BUSCO_out
