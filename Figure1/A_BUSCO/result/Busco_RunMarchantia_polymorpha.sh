...
IN=/usr/users/ashok/OrthologsProject/SpeciesDB/OF_run_remove_them_completely_from_this_dir/Marchantia_polymorpha_v3.1.protein.primaryTranscriptOnly_replaced_ast.fa
...
busco -m $MODE -i $IN -o $OUT -f -l chlorophyta_odb10 -o Marchantia_polymorpha_BUSCO_out
