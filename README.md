...
* New/Redefined Concept
    ...
    * Latent Genetic Potential (LGP): Key (functional) Embryophytic protein domains having Last Common Ancestor prior (LCA) to the LCA of protein with corresponding function
